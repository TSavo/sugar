...
use crate::sugar::{
    ...
    index, infinity_eq, inspect, int_pow, int_sqrt, intersperse_collect_string, intersperse_concat,
    is_empty, is_sorted, iter_next, iter_terminal, iterator, len, literal,
    ...
    primitive_int, range_contains, range_term, raw_addr_term, reference_sequence, reference_term,
    regex_match, repeat_term, result_predicate, result_transpose_collect, rev, sizeof, skip,
