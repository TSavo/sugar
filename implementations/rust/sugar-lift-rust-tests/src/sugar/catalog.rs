...
use crate::sugar::{
    ...
    cstr, dormant_mut_ref, enumerate, field_term, filter, filter_map, float_refinement, fold,
    for_each, for_replay, forall_loop, format_args, format_macro, function_map, identity_map,
    impl_method, index, infinity_eq, int_pow, int_sqrt, intersperse_collect_string,
    ...
    range_term, raw_addr_term, reference_term, regex_match, repeat_term, result_transpose_collect,
