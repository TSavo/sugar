...
use crate::sugar::{
    ...
    int_sqrt, integer_decode, intersperse_collect_string, intersperse_concat, ip_addr, is_empty,
    ...
    matches_macro, maybe_uninit_new, maybe_uninit_zeroed, method, monadic, nonzero, offset_of,
    option_adaptor, option_predicate, option_unwrap, partition_point, path, peekable,
    primitive_int, range_accessor, range_contains, range_term, raw_addr_term, reference_sequence,
    reference_term, regex_match, repeat_term, result_predicate, result_transpose_collect, rev,
    size_hint, sizeof, skip, skip_while, slice_accessor, slice_index, slice_search,
