...
use crate::sugar::{
    ...
    index, infinity_eq, inspect, int_pow, int_sqrt, integer_decode, intersperse,
    intersperse_collect_string, intersperse_concat, ip_addr, is_empty, is_sorted, iter_next,
    ...
    option_unwrap, partition_point, path, peekable, primitive_int, range_accessor, range_construct,
