...
use crate::sugar::{
    ...
    flat_map, flatten, float_refinement, fold, for_each, for_replay, forall_loop, format_args,
    format_macro, from_bool, function_map, identity_map, impl_method, index, infinity_eq, inspect,
    int_pow, int_sqrt, integer_decode, intersperse_collect_string, intersperse_concat, ip_addr,
    is_empty,
