...
use crate::sugar::{
    ...
    dormant_mut_ref, duration_accessor, duration_value, dyn_any, enumerate, field_term, filter,
    filter_map, flat_map, flatten, float_literal_method, float_refinement, fold, for_each,
    for_loop_mutation, for_replay, forall_loop, format_args, format_macro, from_bool, function_map,
    future_join, identity_map, if_sugar, impl_method, index, infinity_eq, inspect, int_midpoint,
...
const EXPR_CLAIMS: &[&ExprSugarClaim] = &[
    ...
    &constraint::PATTERN_GUARD_SUGAR,
    ...
    &binop::EXPR_SUGAR,
    &const_if::EXPR_SUGAR,
    &value_if::PATTERN_GUARD_EXPR_SUGAR,
    &value_if::EXPR_SUGAR,
    ...
    &match_node::RUNTIME_COMPOSITE_EXPR_SUGAR,
    ...
    &reference_term::COMPOSITE_EXPR_SUGAR,
