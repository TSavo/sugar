...
use crate::sugar::{
    ...
    iterator, literal, literal_iterator_quantifier, literal_slice, macro_term, map, match_node,
    match_scrutinee, matches_macro, method, monadic, nonzero, offset_of, option_adaptor,
    option_predicate, option_unwrap, path, primitive_int, range_term, raw_addr_term,
    reference_term, regex_match, repeat_term, rev, sizeof, skip, skip_while, slice_index,
