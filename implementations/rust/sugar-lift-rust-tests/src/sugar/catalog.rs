...
use crate::sugar::{
    ...
    function_map, identity_map, impl_method, index, infinity_eq, inspect, int_pow, int_sqrt,
    intersperse_collect_string, intersperse_concat, iter_terminal, iterator, len, literal,
