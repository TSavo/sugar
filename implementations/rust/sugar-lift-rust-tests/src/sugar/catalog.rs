...
use crate::sugar::{
    ...
    constraint, control_flow_term,
    cstr, dormant_mut_ref, duration_accessor, enumerate, field_term, filter, filter_map, flat_map,
    flatten,
    ...
    int_sqrt, intersperse_collect_string, intersperse_concat, is_empty, is_sorted, iter_terminal,
    iterator, len, literal,
    literal_iterator_quantifier, literal_slice, macro_term, map, match_node, match_scrutinee,
    matches_macro, maybe_uninit_new, maybe_uninit_zeroed, method, monadic, nonzero, offset_of, option_adaptor, option_predicate,
    option_unwrap, partition_point, path, peekable, primitive_int, range_term, raw_addr_term,
    reference_sequence, reference_term, regex_match, repeat_term, result_predicate,
    result_transpose_collect, rev, sizeof, skip,
