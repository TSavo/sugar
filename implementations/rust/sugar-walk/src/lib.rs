...
//
// This crate combines a syn surface lift, effect detection, source-oracle,
// region and pin mementos. It emits FunctionContractMemento values,
...
pub use lift::{
    ...
    lift_function_precondition, lift_predicate, pure_free_guard_arg_is_stable,
    pure_free_guard_expr_effect_roots, PureFreeGuardRule,
};
pub use shadow::{
