...
const EXPECTED_LADDER_SITES: &[ExpectedLadderSite] = &[
    ...
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/emit.rs",
        line: 1086,
        enclosing_fn: "expr_arg_term",
        family: "tail-expr-ite",
        max_signals: 2,
    },
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/emit.rs",
    ...
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/emit.rs",
        line: 1378,
        enclosing_fn: "lower_expr_to_stmt",
        family: "tail-expr-ite",
        max_signals: 18,
    },
    ExpectedLadderSite {
    ...
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/emit.rs",
        line: 1671,
        enclosing_fn: "lower_return_expr_to_value_term",
        family: "tail-expr-ite",
        max_signals: 4,
    },
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/emit.rs",
        line: 1697,
        enclosing_fn: "lower_expr_to_bool_term",
        family: "tail-expr-ite",
        max_signals: 12,
    },
    ExpectedLadderSite {
    ...
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/emit.rs",
        line: 1821,
        enclosing_fn: "lower_expr_to_unit_term",
        family: "tail-expr-ite",
        max_signals: 6,
    },
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/emit.rs",
        line: 1831,
        enclosing_fn: "lower_expr_to_value_term",
        family: "tail-expr-ite",
        max_signals: 22,
    },
    ExpectedLadderSite {
    ...
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/lift.rs",
        line: 1657,
        enclosing_fn: "expr_string_literal",
        family: "tail-expr-ite",
        max_signals: 40,
    },
    ExpectedLadderSite {
    ...
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/lift.rs",
        line: 1805,
        enclosing_fn: "token_string_literal",
        family: "tail-expr-ite",
        max_signals: 9,
    },
    ExpectedLadderSite {
    ...
    ExpectedLadderSite {
        file: "implementations/rust/sugar-walk/src/lift.rs",
        line: 3731,
        enclosing_fn: "receiver_producer_callsite_lift",
        family: "tail-expr-ite",
        max_signals: 40,
    },
    ExpectedLadderSite {
...
fn classify_family(
    ...
    if file.ends_with("lift.rs") {
        if (557..=935).contains(&line)
            || enclosing_fn.contains("tail")
