...
const EXPECTED_FRONTIER: &[(&str, &str, &str, &str)] = &[
    ...
    (
        ...
        "bind_contract_witness_from_evidence",
        "ok",
    ),
    (
        "ok",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "component_plan_claims_base64_vendor_contracts_and_implications",
        "ok",
    ),
    (
        "ok",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "component_plan_result",
        "ok",
    ),
    (
        "ok",
    ...
    (
        "ok",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "resolve_source_memento_rpc_returns_source_from_workspace_root",
        "ok",
    ),
    (
        "ok",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "source_oracle_param_rename_keeps_template_cid_but_drifts_source_cid",
        "ok",
    ),
    (
        "ok",
    ...
    (
        "ok",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "source_oracle_refuses_on_body_drift",
        "ok",
    ),
    (
        "ok",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "source_oracle_refuses_when_function_absent",
        "ok",
    ),
    (
        "ok",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "source_oracle_resolves_matching_source_to_body",
        "ok",
    ),
    (
        "ok",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "source_oracle_same_locus_replacement_reports_name_and_source_drift",
        "ok",
    ),
    (
        "ok",
    ...
    (
        ...
        "assert_macro_condition",
        "ok",
    ),
    (
        "ok",
        "implementations/rust/sugar-walk/src/lift.rs",
        "infer_json_value_tokens",
        "ok",
    ),
    (
        "ok",
    ...
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "binding_is_body_bearing",
        "unwrap_or",
    ),
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "binding_template_from_sugar_entry",
        "unwrap_or",
    ),
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "binding_templates_from_proof",
        "unwrap_or",
    ),
    (
        "unwrap_or",
    ...
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "function_contract_lift",
        "unwrap_or",
    ),
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "function_contract_source_locus",
        "unwrap_or",
    ),
    (
        "unwrap_or",
    ...
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "parse_concept_comment_body",
        "unwrap_or",
    ),
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "resolve_rs_source_files",
        "unwrap_or",
    ),
    (
        "unwrap_or",
    ...
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "source_memento_from_json_value",
        "unwrap_or",
    ),
    (
        "unwrap_or",
    ...
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/lift.rs",
        "collect_local_binding_value_fact",
        "unwrap_or",
    ),
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/lift.rs",
        "infer_indexed_json_value_kind",
        "unwrap_or",
    ),
    (
        "unwrap_or",
    ...
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/lift.rs",
        "method_turbofish_mentions_ident",
        "unwrap_or",
    ),
    (
        "unwrap_or",
    ...
    (
        "unwrap_or",
        "implementations/rust/sugar-walk/src/lift.rs",
        "statement_pure_free_guard_fact_for_is_some",
        "unwrap_or",
    ),
    (
        "unwrap_or",
    ...
    (
        "unwrap_or_default",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "method_postcondition_receiver_is_stable",
        "unwrap_or_default",
    ),
    (
        "unwrap_or_default",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "resolve_cargo_dependency_proof_paths",
        "unwrap_or_default",
    ),
    (
        "unwrap_or_default",
    ...
    (
        "unwrap_or_default",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "resolve_method_calls_via_oracle",
        "unwrap_or_default",
    ),
    (
        "unwrap_or_default",
    ...
    (
        "unwrap_or_default",
        "implementations/rust/sugar-walk/src/bin/walk_rpc.rs",
        "write_rust_vendor_function_contract_proof",
        "unwrap_or_default",
    ),
    (
        "unwrap_or_default",
