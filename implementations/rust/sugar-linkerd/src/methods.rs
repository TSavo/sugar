...
// -------------------------------------------------------------------
// rustAnalyzerReady / resolveReceiverCrate: MOVED to sugar-ra-oracle.
//
// The resident rust-analyzer host (RaHost), the content-addressed resolve
// cache, and the two RPC handlers that served the Rust lift pipeline's
// ra_daemon_client (rustAnalyzerReady, resolveReceiverCrate) were extracted
// into their own crate, sugar-ra-oracle, daemon-1 of the linkerd retirement
// (the daemon's non-editor job gets a new home before the daemon itself is
// deleted). See implementations/rust/sugar-ra-oracle/src/methods.rs.
// -------------------------------------------------------------------
