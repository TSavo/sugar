...
const EXPECTED_STRINGLY_REFUSAL_EMISSIONS: &[ExpectedSite] = &[
    ...
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 8389, needle: "Err(err) => panic!(\"sugar-walk refused unserializable evidence predicate: {err}\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 9314, needle: "_ => panic!(\"sugar-walk RPC operand_symbol refused unknown syn::Expr variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 10038, needle: "_ => panic!(\"sugar-walk RPC expr_sort refused unknown syn::Lit variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 10063, needle: "_ => panic!(\"sugar-walk RPC expr_sort refused unknown syn::UnOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 10099, needle: "_ => panic!(\"sugar-walk RPC expr_sort refused unknown syn::Expr variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 10149, needle: "_ => panic!(\"sugar-walk RPC binary_result_sort refused unknown syn::BinOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 10188, needle: "_ => panic!(\"sugar-walk RPC sort_from_type refused unknown syn::Type variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 10234, needle: "_ => panic!(\"sugar-walk RPC binary_operator_name refused unknown syn::BinOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 10246, needle: "_ => panic!(\"sugar-walk RPC unary_operator_name refused unknown syn::UnOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 10340, needle: "panic!(\"sugar-walk refused integer literal outside canonical i128 floor: {err}\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 10455, needle: "panic!(\"sugar-walk refused local op CID canonicalization for `{operator}`: {err}\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ...
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 1570, needle: "_ => panic!(\"sugar-walk emit receiver source refused unknown syn::Expr variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 1620, needle: "_ => panic!(\"sugar-walk emit mutable borrow source refused unknown syn::Expr variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2356, needle: "panic!(\"sugar-walk emit expr_sort refused unknown syn::UnOp variant\");", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2376, needle: "panic!(\"sugar-walk emit expr_sort refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2394, needle: "panic!(\"sugar-walk emit expr_sort refused unknown syn::Lit variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2460, needle: "_ => panic!(\"sugar-walk emit logical op refused unknown syn::BinOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2484, needle: "_ => panic!(\"sugar-walk emit comparison op refused unknown syn::BinOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2508, needle: "_ => panic!(\"sugar-walk emit arithmetic op refused unknown syn::BinOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2532, needle: "_ => panic!(\"sugar-walk emit bitwise op refused unknown syn::BinOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2584, needle: "_ => panic!(\"sugar-walk emit sort_from_type refused unknown syn::Type variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2661, needle: "_ => panic!(\"sugar-walk emit concept_sort refused unknown syn::Type variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2722, needle: "_ => panic!(\"sugar-walk emit partial_return_loss refused unknown syn::Type variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/emit.rs", line: 2821, needle: "_ => panic!(\"sugar-walk emit local_pat_type refused unknown syn::Pat variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 975, needle: "panic!(\"sugar-walk pattern name collector refused opaque syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 979, needle: "panic!(\"sugar-walk pattern name collector refused unknown syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1243, needle: "panic!(\"sugar-walk len receiver classifier refused uninterpreted verbatim expression\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1247, needle: "panic!(\"sugar-walk len receiver classifier refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1300, needle: "panic!(\"sugar-walk root identifier classifier refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1308, needle: "Err(err) => panic!(\"sugar-walk refused unserializable IR term key: {err}\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1383, needle: "panic!(\"sugar-walk local binding classifier refused unknown syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1553, needle: "panic!(\"sugar-walk assignment target collector refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1688, needle: "panic!(\"sugar-walk string literal classifier refused uninterpreted verbatim expression\");", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1693, needle: "panic!(\"sugar-walk string literal classifier refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1703, needle: "panic!(\"sugar-walk string literal classifier refused unknown syn::Lit variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2222, needle: "panic!(\"sugar-walk guarded panic collector refused uninterpreted verbatim expression\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2224, needle: "_ => panic!(\"sugar-walk guarded panic collector refused unknown syn::Expr variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2292, needle: "panic!(\"sugar-walk pure-free guard collector refused uninterpreted verbatim expression\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2296, needle: "panic!(\"sugar-walk pure-free guard collector refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2649, needle: "panic!(\"sugar-walk keyset source classifier refused uninterpreted verbatim expression\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2653, needle: "panic!(\"sugar-walk keyset source classifier refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2698, needle: "panic!(\"sugar-walk local single-pattern classifier refused unknown syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2725, needle: "panic!(\"sugar-walk single-pattern classifier refused unknown syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2751, needle: "panic!(\"sugar-walk tuple-pattern classifier refused unknown syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2850, needle: "panic!(\"sugar-walk method-call classifier refused uninterpreted verbatim expression\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2854, needle: "panic!(\"sugar-walk method-call classifier refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2945, needle: "panic!(\"sugar-walk call classifier refused uninterpreted verbatim expression\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 2949, needle: "panic!(\"sugar-walk call classifier refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3137, needle: "panic!(\"sugar-walk expression root collector refused opaque syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3141, needle: "panic!(\"sugar-walk expression root collector refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3157, needle: "panic!(\"sugar-walk expression root collector refused opaque statement macro\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3274, needle: "panic!(\"sugar-walk assignment root collector refused uninterpreted verbatim expression\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3278, needle: "panic!(\"sugar-walk assignment root collector refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3348, needle: "panic!(\"sugar-walk pattern binding collector refused opaque syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3352, needle: "panic!(\"sugar-walk pattern binding collector refused unknown syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3400, needle: "panic!(\"sugar-walk pattern binder refused opaque syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3404, needle: "panic!(\"sugar-walk pattern binder refused unknown syn::Pat variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3644, needle: "_ => panic!(\"sugar-walk predicate classifier refused unknown syn::Expr variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3785, needle: "panic!(\"sugar-walk receiver producer classifier refused uninterpreted verbatim expression\");", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3790, needle: "panic!(\"sugar-walk receiver producer classifier refused unknown syn::Expr variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 3875, needle: "_ => panic!(\"sugar-walk term classifier refused unknown syn::Lit variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 4192, needle: "_ => panic!(\"sugar-walk term classifier refused unknown syn::BinOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 4217, needle: "_ => panic!(\"sugar-walk term classifier refused unknown syn::UnOp variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 4244, needle: "panic!(\"sugar-walk term classifier refused uninterpreted verbatim expression\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 4246, needle: "_ => panic!(\"sugar-walk term classifier refused unknown syn::Expr variant\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 4298, needle: "panic!(\"sugar-walk predicate operator classifier refused unknown syn::BinOp variant\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ...
    ExpectedSite { ground: "path-composition-refusal-effect", path: "implementations/rust/sugar-cli/src/kit_path/path_executor.rs", line: 166, needle: ".ok_or_else(|| PathExecutionError::Refused(Box::new(missing_kit_refusal(step))))?;", replacement: "CompositionEffect::MissingRequirement from PathExecutionError" },
    ExpectedSite { ground: "path-composition-refusal-effect", path: "implementations/rust/sugar-cli/src/kit_path/path_executor.rs", line: 236, needle: "Err(PathExecutionError::Refused(Box::new(", replacement: "CompositionEffect::MissingRequirement from PathExecutionError" },
    ExpectedSite { ground: "path-composition-refusal-effect", path: "implementations/rust/sugar-cli/src/kit_path/path_executor.rs", line: 344, needle: "PathExecutionError::Refused(Box::new(prove_not_supported_refusal(step)))", replacement: "CompositionEffect::MissingRequirement from PathExecutionError" },
    ...
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 2632, needle: "return _UnsupportedSyntax(", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 2668, needle: "return _UnsupportedSyntax(", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 2781, needle: "self._refuse(", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 2788, needle: "self._refuse(", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 2795, needle: "self._refuse(node, \"generators are refused\", kind=\"generator-refused\")", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 2798, needle: "self._refuse(node, \"generators are refused\", kind=\"generator-refused\")", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 2801, needle: "self._refuse(node, \"await expressions are refused\")", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 2811, needle: "self.refused = _UnsupportedSyntax(node, reason, kind=kind)", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 2827, needle: "raise _UnsupportedSyntax(node, \"star imports are refused\")", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ExpectedSite { ground: "python-unsupported-syntax-effect", path: "implementations/python/sugar-lift-python-source/src/sugar_lift_python_source/lifter.py", line: 3250, needle: "raise _UnsupportedSyntax(", replacement: "PythonLiftEffect variant for the refused syntax ground" },
    ...
    ExpectedSite { ground: "rust-walk-source-effect-status", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 18533, needle: "\"status\": \"refused\",", replacement: "RustWalk source effect status variant with source ledger ground" },
