...
const EXPECTED_STRINGLY_REFUSAL_EMISSIONS: &[ExpectedSite] = &[
    ...
    ExpectedSite { ground: "rust-lift-duration-effect", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/duration_value.rs", line: 156, needle: "DurationDecision::Refused { .. } => None,", replacement: "RustLiftEffect::DurationCarrierEmbedding carrying boundary and carrier ground" },
    ...
    ExpectedSite { ground: "rust-lift-effect", path: "implementations/rust/sugar-lift-rust-tests/src/lib.rs", line: 9533, needle: "format!(\"unsupported term: {reason}; refused\")", replacement: "RustLiftEffect variant carrying the source/runtime ground" },
    ...
    ExpectedSite { ground: "rust-lift-effect", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/duration_value.rs", line: 72, needle: "Refused { boundary: String, reason: String },", replacement: "RustLiftEffect variant carrying the source/runtime ground" },
    ExpectedSite { ground: "rust-lift-effect", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/duration_value.rs", line: 100, needle: "return Some(DurationDecision::Refused {", replacement: "RustLiftEffect variant carrying the source/runtime ground" },
    ...
    ExpectedSite { ground: "rust-lift-terminal-classifier", path: "implementations/rust/sugar-lift-rust-tests/src/lib.rs", line: 4187, needle: ".find(|reason| matches!(refusal_disposition(reason), Disposition::Refused))", replacement: "RustLiftEffect classifier enum instead of reason-prose whitelist" },
    ExpectedSite { ground: "rust-lift-terminal-classifier", path: "implementations/rust/sugar-lift-rust-tests/src/lib.rs", line: 4210, needle: ".find(|reason| matches!(refusal_disposition(reason), Disposition::Refused))", replacement: "RustLiftEffect classifier enum instead of reason-prose whitelist" },
    ExpectedSite { ground: "rust-lift-terminal-classifier", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/factory.rs", line: 881, needle: "Disposition::Refused => (FactoryDisposition::Refused, \"effect\", Some(reason)),", replacement: "RustLiftEffect classifier enum instead of reason-prose whitelist" },
    ExpectedSite { ground: "rust-lift-terminal-classifier", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/factory.rs", line: 946, needle: "FactoryDisposition::Refused | FactoryDisposition::Unresolved", replacement: "RustLiftEffect classifier enum instead of reason-prose whitelist" },
