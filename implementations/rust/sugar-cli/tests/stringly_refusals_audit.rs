...
const EXPECTED_STRINGLY_REFUSAL_EMISSIONS: &[ExpectedSite] = &[
    ...
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/bin/walk_rpc.rs", line: 8815, needle: "panic!(\"sugar-walk refused unparsable Rust source while extracting body for `{fn_name}`: {err}\")", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ...
    ExpectedSite { ground: "coverage-panic-wording", path: "implementations/rust/sugar-walk/src/lift.rs", line: 1100, needle: "Err(err) => panic!(\"sugar-walk refused unparsable assert! condition: {err}\"),", replacement: "coverage ICE/panic with typed frontier owner; do not encode as refused prose" },
    ...
    ExpectedSite { ground: "rust-lift-duration-effect", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/duration_value.rs", line: 61, needle: "DurationDecision::Refused { boundary, reason } => {", replacement: "RustLiftEffect::DurationCarrierEmbedding carrying boundary and carrier ground" },
    ExpectedSite { ground: "rust-lift-duration-effect", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/duration_value.rs", line: 157, needle: "DurationDecision::Refused { .. } => None,", replacement: "RustLiftEffect::DurationCarrierEmbedding carrying boundary and carrier ground" },
    ...
    ExpectedSite { ground: "rust-lift-terminal-classifier", path: "implementations/rust/sugar-lift-rust-tests/src/lib.rs", line: 4186, needle: ".find(|reason| matches!(refusal_disposition(reason), Disposition::Refused))", replacement: "RustLiftEffect classifier enum instead of reason-prose whitelist" },
    ExpectedSite { ground: "rust-lift-terminal-classifier", path: "implementations/rust/sugar-lift-rust-tests/src/lib.rs", line: 4209, needle: ".find(|reason| matches!(refusal_disposition(reason), Disposition::Refused))", replacement: "RustLiftEffect classifier enum instead of reason-prose whitelist" },
    ExpectedSite { ground: "rust-lift-terminal-classifier", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/factory.rs", line: 889, needle: "Disposition::Refused => (FactoryDisposition::Refused, \"effect\", Some(reason)),", replacement: "RustLiftEffect classifier enum instead of reason-prose whitelist" },
    ExpectedSite { ground: "rust-lift-terminal-classifier", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/factory.rs", line: 954, needle: "FactoryDisposition::Refused | FactoryDisposition::Unresolved", replacement: "RustLiftEffect classifier enum instead of reason-prose whitelist" },
    ExpectedSite { ground: "rust-lift-terminal-classifier", path: "implementations/rust/sugar-lift-rust-tests/src/sugar/iter_terminal.rs", line: 1713, needle: "Disposition::Refused => {", replacement: "RustLiftEffect classifier enum instead of reason-prose whitelist" },
