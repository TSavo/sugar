...
use libsugar::core::{
    address, compose, link, prove, transform, verify, ArityShape, AritySlot, CKit, Canonical,
    Catalog, Cid, ConformanceDeclaration, Dialect, DomainClaim, DomainKind, FunctionContractDomain,
    HashMapCatalog, HashMapInputCatalog, Input, InputCatalog, Kit, LanguageSignature, Path,
    PathAlgebra, PathDocument, PathDocumentError, PathError, Refutation, SlotSort, Term, Truth,
...
// lift_plugin_transport_is_a_core_kit_with_legacy_response_escape_hatch,
// lift_kit_transforms_source_through_lift_plugin_transport_and_carries_term_payload,
// execute_path_refuses_unregistered_lift_kit_with_composition_refusal_memento, and
// kit_registry_register_requires_and_exposes_conformance_declaration relocated to
// sugar-cli/tests/kit_path.rs by #evict-2-liftplugin-pathexec (LiftPluginKit, LiftKit,
// execute_path, and KitRegistry moved from libsugar::core to sugar_cli::kit_path).
