...
class ModuloByZeroRuntimeEffect(RuntimeEffect):
    """Modulo by a concrete zero halts the program at runtime; the identity is the
    ...
    def kind(self) -> type[RuntimeEffect]:
        return ModuloByZeroRuntimeEffect
