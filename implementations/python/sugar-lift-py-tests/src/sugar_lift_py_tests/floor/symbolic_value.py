...
class SymbolicValue(FloorValue):
    ...
    def subscript(self, index, site):
        # A generic symbolic receiver stays the py.subscript coordinate. A
        # declaration-owned formal emits that same candidate once, gated by
        # the exact indexability demand for later linker discharge.
