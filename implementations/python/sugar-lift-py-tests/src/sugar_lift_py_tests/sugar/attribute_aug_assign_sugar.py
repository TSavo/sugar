...
class AttributeAugAssignSugar(Sugar, role=SugarRole.STATEMENT):
    """A non-add attribute augassign is its ordinary read/operator/store sequence."""
    ...
    @classmethod
    def new(cls, site, ctx) -> "AttributeAugAssignSugar":
        target = site.aug_assign_target()
    ...
    def witnesses(cls):
        ...
        return _call_pair(
            name="attribute_bitor_assign_return",
    ...
    def desugar(self, ctx: object = None) -> Outcome:
        ...
        return self.receiver.reduce(ctx).and_then(
            lambda receiver: self.updated_value.reduce(ctx).and_then(
    ...
    def walk_children(self):
        return (self.receiver, self.updated_value)
