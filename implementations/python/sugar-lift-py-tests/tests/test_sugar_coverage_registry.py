...
COVERAGE: dict[str, list[str]] = {
    ...
    "with_sugar": ["test_object_context_manager_dunder.py"],
    "attribute_assign_sugar": ["test_attribute_descriptor_dunders.py"],
    "attribute_delete_sugar": ["test_attribute_descriptor_dunders.py"],
    "subscript_assign_sugar": ["test_mutation_container_dunders.py"],
    "subscript_delete_sugar": ["test_mutation_container_dunders.py"],
    "await_sugar": ["test_object_async_context_dunder.py"],
    "async_with_sugar": ["test_object_async_context_dunder.py"],
    "async_for_sugar": ["test_object_async_context_dunder.py"],
    ...
    "builtin_call_sugar": ["test_builtin_call_sugar.py"],
    ...
    "chained_comparison_assertion_sugar": [
        "test_chained_comparison_assertion_sugar.py"
    ],
    ...
    "object_equality_term_sugar": ["test_callsite_value_demand.py"],
    "object_rich_comparison_term_sugar": [
        "test_object_rich_comparison_dunder.py"
    ],
