...
def test_factory_spine_frontier_pins_current_xsugar_bypass_baseline() -> None:
    ...
    assert [f"{o.path}:{o.line}" for o in report.offenders] == [
        "factory/array_map_report.py:203",
        "factory/array_map_report.py:312",
        "factory/array_map_report.py:314",
        "factory/literal_call_report.py:812",
        "floor/call_site_value.py:226",
        "sugar/builtin_call_sugar.py:58",
        "sugar/builtin_call_sugar.py:171",
        "sugar/builtin_call_sugar.py:257",
...
def test_factory_spine_frontier_cli_exits_red_with_pinned_bypasses(
    ...
    assert "factory/literal_call_report.py:812" in stdout
    assert "floor/call_site_value.py:226" in stdout
    assert "sugar/builtin_call_sugar.py:58" in stdout
