...
Claim-mass slice for #4266: keeps the assert-dense ArrayMemoryError and
UFuncNoLoopError arms. TestAxisError is excluded because multi-target
unpack assign (`axis, ndim, *_ = args`) still lacks Assign sugar and panics
the audit door after hold_panic retirement.
"""
